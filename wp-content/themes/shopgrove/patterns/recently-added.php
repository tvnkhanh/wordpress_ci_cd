...
if ( $results )  {
?>
<!-- wp:group {"metadata":{"name":"recent-product"},"style":{"spacing":{"padding":{"top":"var:preset|spacing|50","bottom":"var:preset|spacing|50"},"margin":{"top":"0","bottom":"0"}}},"className":"animated fadeInUp","layout":{"type":"constrained"}} -->
...
<h2 class="wp-block-heading has-text-align-left has-body-font-family" style="font-size:36px;font-style:normal;font-weight:700"><?php echo esc_html__( 'Recently', 'shopgrove' ); ?> <strong><?php echo esc_html__( 'Added', 'shopgrove' ); ?></strong></h2>
<!-- /wp:heading --></div>
<!-- /wp:column -->
...
<div class="wp-block-column"><!-- wp:query {"queryId":10,"query":{"perPage":"4","pages":0,"offset":0,"postType":"product","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":false,"__woocommerceAttributes":[],"__woocommerceStockStatus":["instock","outofstock","onbackorder"]},"namespace":"woocommerce/product-query"} -->
...
<!-- wp:woocommerce/product-price {"isDescendentOfQueryLoop":true,"textAlign":"center","style":{"typography":{"fontSize":"16px","fontStyle":"normal","fontWeight":"500"},"spacing":{"margin":{"top":"var:preset|spacing|10","bottom":"0","left":"0","right":"0"},"padding":{"top":"0","bottom":"0"}},"elements":{"link":{"color":{"text":"#515151"}}},"color":{"text":"#515151"}}} /-->
