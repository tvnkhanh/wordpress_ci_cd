<?php
  ...
  * Slug: shopgrove/blog-left-sidebar
  */
?>
...
<h1 class="wp-block-heading has-text-align-center has-link-color-color has-text-color has-link-color"><?php echo esc_html__( 'Blog', 'shopgrove' ); ?></h1>
<!-- /wp:heading --></div></main>
<!-- /wp:cover -->
